...
export const SUITES: SuiteDef[] = [
    ...
    {
        id: 'image-buffer',
        script: 'scripts/test/image-buffer.ts',
        group: 'cpu',
        packages: ['@dxo/core'],
        platforms: ['all'],
        backend: ['cpu'],
    ...
    {
        id: 'vision-image-bridge',
        script: 'scripts/test/vision-image-bridge.ts',
        group: 'product',
        packages: ['@dxo/core', '@dxo/vision'],
        platforms: ['all'],
        backend: ['cpu'],
        requiresGpu: false,
        requiresNetwork: false,
    ...
    {
        id: 'precision-capabilities',
        script: 'scripts/test/precision-capabilities.ts',
        group: 'contract',
        packages: ['@dxo/core'],
        platforms: ['all'],
        backend: ['cpu', 'cuda'],
    ...
    {
        id: 'precision-fallback-diagnostics',
        script: 'scripts/test/precision-fallback-diagnostics.ts',
        group: 'contract',
        packages: ['@dxo/core', '@dxo/serialize'],
        platforms: ['all'],
        backend: ['cpu', 'cuda'],
        requiresGpu: false,
        requiresNetwork: false,
